...
<template>
    <div class="app">
        <div class="head">
            ...
            <span class="headInfo">Internet identity:
                jn7b3-bvjst-diijha-7vvrd-weftu-3jx63-qagnq-nkdjb-fltbn-4plec-</span>
        </div>
        <div class="content">
            <div class="contentBox">
                <div class="contentTab">
                    <div class="contentItem" v-for="(item, index) in conTabList" :key="index"
                        :class="{ chooseClass: item.select }" @click="chooseFun(item)">{{ item.name }}</div>
                </div>
