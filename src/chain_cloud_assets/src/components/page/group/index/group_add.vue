    ...
    <div class="app">
        <div class="content">
            ...
            <div class="contentbox">
                <div class="left">
                    <div class="wordStyle">Groups allow you to manage and collaborate across multiple projects. Members
                        of a group have access to all of its projects.</div>
                    <div class="wordStyle">Groups can also be nested by creating subgroups.</div>
                ...
                <div class="right">
                    <div class="nameItem">
                        ...
                        <Input placeholder="Production group" style="width:320px;margin-top:10px" :clearable="true" />
                    </div>
                    <div class="nameItem">
                        <span>Group URL</span>
                        <Input placeholder="my-awesome-group" style="width:720px;margin-top:10px" :clearable="true" />
                    </div>
                            ...
                            <Radio-group v-model="type">
                                <div class="radioBox">
                                    <Radio label="Private">
                                        ...
                                        <span class="radioDec">The group and its projects can only be viewed by
                                            mambers.</span>
                                    </Radio>
                                </div>
                                <div class="radioBox">
                                    <Radio label="Public">
                                        ...
                                        <span class="radioDec">The group and any pubilc projects can be viewed without
                                            any
                                            authentication.</span>
                                    </Radio>
                                </div>
